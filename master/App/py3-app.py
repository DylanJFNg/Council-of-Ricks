...
def english():
    ...
    def quiz():
        ...
        def ask_question():
            ...
            score_readout = Label(mat, text="Score: " + str(score) + "/" + str(count), font=(None,15),fg="blue",bg="yellow")
            ...
            question_label = Label(mat, text=qq[4], font=(None,10),fg="blue",bg="yellow",wraplength=750)
